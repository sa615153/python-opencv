...
# set a condition that atleast 10 matches (defined by MIN_MATCH_COUNT) are to be there to find the object

# extract the locations of matched keypoints in both the images
# passed to find the perpective transformation
...
if len(good)>MIN_MATCH_COUNT:
    ...
    M, mask = cv2.findHomography(src_pts, dst_pts, cv2.RANSAC,5.0)  # M is the transform matrix
